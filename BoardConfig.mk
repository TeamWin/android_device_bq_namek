...
TARGET_CUSTOM_KERNEL_HEADERS := device/bq/namek/include
...
BOARD_MKBOOTIMG_ARGS := --dt device/bq/namek/dt.img --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/bq/namek/recovery/etc/twrp.fstab
